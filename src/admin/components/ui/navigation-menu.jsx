...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center gap-1.5 rounded-md bg-transparent px-3 py-2 text-[12.5px] font-medium text-muted transition-colors hover:bg-bg-soft hover:text-ink focus:bg-bg-soft focus:text-ink focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:text-primary data-[state=open]:text-ink data-[state=open]:bg-bg-soft"
)
